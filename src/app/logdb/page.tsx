  ...
  const saveData = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (vendedor) {
        ...
        // NOTE: Specifying foreign key constraint to handle multiple ClienteSucursal->Bonificaciones relationships.
        // See BONIFICACIONES_FIX.md for details and alternatives if this constraint name doesn't match your database.
